...
function contestData(){
    ...
    let participantsNames = ["Erwto","MidnightRunner","Migger","SpartaX18","Škoda Favorit GLX SilverLine","Tornado","XsaraTorrada","Yenchey"]
    let participants = []
    ...
    let Yenchey = contest.GetParticipantByName(participantsNames[7]);
